...
namespace Telerik.JustDecompiler.External.Interfaces
{
    ...
    public interface IDecompiler
    {
		...
		Dictionary<MemberIdentifier, string> Generate(string target, string sourcesRoot, string pdbPath, SupportedLanguages language, IFrameworkResolver resolver, IFileGenerationNotifier notifier, IDecompilationPreferences decompilationPreferences, CancellationToken cancellationToken);
		...
		Dictionary<MemberIdentifier, string> Generate(string target, string sourcesRoot, string pdbPath, SupportedLanguages language, IFrameworkResolver resolver, IFileGenerationNotifier notifier, IDecompilationPreferences decompilationPreferences, CancellationToken cancellationToken, Dictionary<MemberIdentifier, string> existingClassesMap);
#else
		/// <summary>
		/// Generates a PDB file dor a given assembly.
		/// </summary>
